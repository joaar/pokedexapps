    ...
    <Router>
      <main className="container mx-auto flex flex-col">
        ...
        <div className="flex justify-center">
          <Link to="/login" className="w-20 p-1 bg-red-600 text-white rounded-lg mt-2 font-bold duration-200 hover:bg-red-700 mr-2 text-center">Login</Link>
          <Link to="/signup" className="w-20 p-1 bg-red-600 text-white rounded-lg mt-2 font-bold duration-200 hover:bg-red-700 mr-2 text-center">Sign Up</Link>
        </div>
        <Routes>
